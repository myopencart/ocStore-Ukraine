...
$_['text_success'] 		= 'Успіх: Ви змінили доставку UPS!';
...
$_['text_eu'] 			= 'Місце походження: Євросоюз';
$_['text_pr'] 			= 'Місце походження: Пуерто-Ріко';
...
$_['text_2nd_day_air_am'] 	= 'UPS Second Day Air AM';
...
$_['entry_postcode'] 		= 'Zip / поштовий індекс місця походження';
$_['entry_test'] 		= 'Тестовий режим';
$_['entry_quote_type'] 		= 'Quote Type';
$_['entry_service'] 		= 'Послуги';
$_['entry_insurance'] 		= 'Включити страхування';
$_['entry_display_weight'] 	= 'Показати вага посилки';
...
$_['help_length_class'] 	= 'Вибрати сантиметри або дюйми.';
...
$_['help_debug'] = 'Зберігати дані про посилках в системному журналі';
// Error
$_['error_permission'] 		= 'Увага: Немає прав для на зміну налаштувань доставки UPS (США)!';
$_['error_key'] 		= 'Необхідно ключ доступу!';
